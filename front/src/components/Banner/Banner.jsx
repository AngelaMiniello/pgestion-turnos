      ...
      <div className={styles.rowBanner}>
        <div className={styles.colBanner}>
          <div className={styles.textContent}>
            ...
            <h1 className={styles.bannerp}>
              Todo lo que tu salud necesita en un solo lugar
            </h1>

            <p className={styles.bannerd}>
          ...
          <div className={styles.features}>
            <div className={styles.featureicon}>
              <div className={styles.fimg}>
                <img
                  src="/assets/img/imgespecialidades.png"
                  alt="Especialidades médicas"
                  className={styles.featureimgage}
                />
              </div>
            ...
            <div className={styles.featureicon}>
              <div className={styles.fimg}>
                <img
                  src="/assets/img/imgurgencias.png"
