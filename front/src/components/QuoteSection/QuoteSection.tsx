    ...
    <section className="flex w-full items-center justify-center bg-[#f7faff] px-5 py-20 sm:px-8 lg:py-24 gap-4">
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <blockquote className="mx-auto max-w-3xl">
          <p className="text-xl font-light italic leading-relaxed text-[#1f3557] sm:text-3xl lg:text-[2.15rem]">
      ...
      {/* Separador */}
      <div className="mx-auto mt-10 h-1 w-14 rounded-full bg-[#a80b29]" />
