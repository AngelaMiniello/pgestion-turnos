  ...
  return (
    <main className="flex min-h-[calc(100vh-80px)] w-full items-center justify-center bg-[#f5f6f8] px-5 py-16 sm:px-6 lg:px-8">
      <div className="w-full max-w-5xl"> 
        <div className="grid overflow-hidden rounded-3xl border border-[#e3e9f1] bg-white shadow-[0_20px_60px_rgba(0,55,120,0.10)] lg:grid-cols-[0.9fr_1.1fr]">
          
          {/* Panel izquierdo */} 
          <div className="relative hidden overflow-hidden bg-[#073b7a] px-10 py-12 lg:flex lg:flex-col lg:justify-between">
            ...
            <div className="relative z-10"> 
              <div className="mb-8 flex h-16 w-16 items-center justify-center rounded-2xl bg-white/10 text-white backdrop-blur-sm"> 
              ...
              <h2 className="mt-5 max-w-sm text-4xl font-bold leading-tight text-white"> 
                Tu salud, 
                <br /> 
                siempre cerca. 
              </h2>
          ...
          <div className="px-6 py-10 sm:px-10 sm:py-12 lg:px-14 lg:py-14"> 
            ...
            <div className="mb-8 flex flex-col items-center text-center lg:items-start lg:text-left"> 
              <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#e8f2ff] text-[#004aad] lg:hidden"> 
              ...
              <h1 className="mt-5 text-3xl font-bold tracking-tight text-[#073b7a] sm:text-4xl"> 
                Bienvenido
              </h1> 
              <p className="mt-3 max-w-md text-sm leading-6 text-[#68758a]"> 
            ...
            <Formik initialValues={initialValues} validate={validateLogin} onSubmit={handleOnSubmit} >
              {({ isValid, dirty }) => ( 
                ...
                {/* Usuario */} 
                <div> 
                  <label htmlFor="username" className="mb-2.5 block text-sm font-semibold text-[#1f3557]" > 
                    Nombre de usuario 
                  </label>
                ...
                {/* Contraseña */} 
                <div> 
                  <label htmlFor="password" className="mb-2.5 block text-sm font-semibold text-[#1f3557]" > 
                    Contraseña 
                  </label>
          ...
          {/* Seguridad */} 
          <div className="mt-7 flex items-center justify-center gap-2 border-t border-[#edf1f5] pt-6"> 
